...
class dna_entry(object):
	...
	def compare_sequence(self, otherdna_entry_obj):
		if self.sequence == otherdna_entry_obj.sequence and self.gene_name == otherdna_entry_obj.gene_name and self.gene_species == otherdna_entry_obj.gene_species:
		return

dna_entry_obj = dna_entry(gene_name = 'notum', gene_species = 'Homo sapiens', sequence = 'AGTGTGTATGATAGTA')
otherdna_entry_obj = dna_entry(gene_name = 'notum', gene_species = 'Homo sapiens', sequence = 'AGTGTGTATGATAGTA')
...
print(dna_entry_obj.compare_sequence(otherdna_entry_obj)
